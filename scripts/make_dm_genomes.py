...
def main():
    ...
    parser.add_argument(
        ...
        "--data_managers_file",
        required=True,
        help="The data managers tool .yml file.",
    )
    parser.add_argument(
        "-x",
        "--shed_data_managers_conf_file",
        required=True,
        help="Path to the shed_data_managers_conf.xml file",
    )
    parser.add_argument(
        "-g", "--genome_file", required=True, help="The genome yaml file to read."
    )
    parser.add_argument(
        "-o",
        "--outfile",
        default="dm_genomes.yml",
    ...
    # Read in the shed_data_managers_conf.xml file and build a dictionary of
    # name, id and data tables to update and add them to
